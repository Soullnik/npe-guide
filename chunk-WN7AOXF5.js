...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=F)});var r,l,B,I=o(()=>{f();h();t();u();p();s();v();m();S();d();c();E();n();a();C();g();R();r="backgroundPixelShader",l=`#include<backgroundUboDeclaration>
