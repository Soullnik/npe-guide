import{a as u}from"./chunk-NB3FON6B.js";import{a as D}from"./chunk-ZT66VFBE.js";import{a as e,b as t}from"./chunk-RR3YIVG4.js";import{e as o}from"./chunk-FAF55DAL.js";var i,L,h=o(()=>{"use strict";t();u();i="pbrFragmentExtraDeclaration",L=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=L)});var r,A,p=o(()=>{"use strict";t();r="subSurfaceScatteringFunctions",A=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A)});var a,C,S=o(()=>{"use strict";t();a="pbrHelperFunctions",C=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=C)});var n,m,v=o(()=>{"use strict";t();D();n="pbrDirectLightingSetupFunctions",m=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=m)});var l,O,R=o(()=>{"use strict";t();l="pbrDirectLightingFalloffFunctions",O=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=O)});var f,N,_=o(()=>{"use strict";t();f="pbrDirectLightingFunctions",N=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=N)});var c,I,T=o(()=>{"use strict";t();c="pbrIBLFunctions",I=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=I)});var s,F,M=o(()=>{"use strict";t();s="pbrBlockNormalGeometric",F=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=F)});var d,G,b=o(()=>{"use strict";t();d="pbrBlockImageProcessing",G=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=G)});var g,B,P=o(()=>{"use strict";t();g="pbrBlockPrePass",B=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=B)});var E,U,y=o(()=>{"use strict";t();E="pbrDebug",U=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=U)});export{h as a,p as b,S as c,v as d,R as e,_ as f,T as g,M as h,b as i,P as j,y as k};
