...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=B)});var i,_,xe,X=t(()=>{n();Y();O();V();N();W();l();A();R();T();x();P();o();d();v();D();I();s();S();M();m();c();p();u();F();C();G();a();f();U();g();L();h();i="openpbrVertexShader",_=`#define OPENPBR_VERTEX_SHADER
