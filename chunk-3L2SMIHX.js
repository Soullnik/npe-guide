import{a as Le,b as _e,c as he,d as De,e as Fe,f as Pe,g as Ue,h as be,i as Be,j as ye,k as Ge}from"./chunk-5YOEERMD.js";import{a as Me,b as ge}from"./chunk-ZLUVLGHH.js";import{a as Oe}from"./chunk-NLYTMR5R.js";import{a as pe}from"./chunk-4QJKXG75.js";import{a as Te}from"./chunk-NOKOI7UI.js";import{a as Se}from"./chunk-VSOEPTHZ.js";import{a as $,b as ee,c as ie,d as ue,e as Ne}from"./chunk-Z6AOW57W.js";import{a as Ie}from"./chunk-TKQC2XFE.js";import{a as ve}from"./chunk-MFJUZDUZ.js";import{b as Ae}from"./chunk-KLJVN62P.js";import{b as ce}from"./chunk-R4MD35ZT.js";import{b as le}from"./chunk-NAYG47SM.js";import{b as de}from"./chunk-DSYMMEFW.js";import{b as se}from"./chunk-M7OMMD6T.js";import{a as fe}from"./chunk-SEZPQQJY.js";import{b as Ee}from"./chunk-CGKO47GG.js";import{b as Re}from"./chunk-ENWF5TL3.js";import{b as Ce}from"./chunk-F2BF3OFM.js";import{b as me}from"./chunk-TVPEZIUA.js";import{a as Q}from"./chunk-PNTHVEFJ.js";import{b as ne}from"./chunk-EQZDMUTF.js";import{b as ae}from"./chunk-LEMWRMW2.js";import{a as re}from"./chunk-GHDU24UV.js";import{b as oe}from"./chunk-E72SSLFF.js";import{b as te}from"./chunk-BU36H27E.js";import{b as j}from"./chunk-3Q5BZMII.js";import{a as e,b as n}from"./chunk-RR3YIVG4.js";import{e as i}from"./chunk-FAF55DAL.js";var o,Ve,f=i(()=>{"use strict";n();$();o="pbrFragmentDeclaration",Ve=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=Ve)});var t,He,c=i(()=>{"use strict";n();t="samplerFragmentAlternateDeclaration",He=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=He)});var l,xe,d=i(()=>{"use strict";n();fe();c();l="pbrFragmentSamplersDeclaration",xe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=xe)});var s,We,E=i(()=>{"use strict";n();Se();s="pbrBlockAlbedoOpacity",We=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=We)});var R,ke,C=i(()=>{"use strict";n();R="pbrBlockReflectivity",ke=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=ke)});var m,Ye,S=i(()=>{"use strict";n();m="pbrBlockAmbientOcclusion",Ye=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Ye)});var u,Xe,A=i(()=>{"use strict";n();u="pbrBlockAlphaFresnel",Xe=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Xe)});var I,we,v=i(()=>{"use strict";n();I="pbrBlockAnisotropic",we=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=we)});var N,Ke,T=i(()=>{"use strict";n();N="pbrBlockReflection",Ke=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Ke)});var O,ze,p=i(()=>{"use strict";n();O="pbrBlockSheen",ze=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ze)});var L,Ze,_=i(()=>{"use strict";n();L="pbrBlockClearcoat",Ze=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Ze)});var M,qe,h=i(()=>{"use strict";n();M="pbrBlockIridescence",qe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=qe)});var D,Je,F=i(()=>{"use strict";n();D="pbrBlockSubSurface",Je=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Je)});var g,je,a=i(()=>{"use strict";n();g="pbrBlockReflectance0",je=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=je)});var P,Qe,U=i(()=>{"use strict";n();re();a();P="pbrClusteredLightingFunctions",Qe=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Qe)});var b,$e,B=i(()=>{"use strict";n();b="pbrBlockNormalFinal",$e=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=$e)});var y,ei,G=i(()=>{"use strict";n();y="pbrBlockLightmapInit",ei=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=ei)});var V,ii,H=i(()=>{"use strict";n();V="pbrBlockGeometryInfo",ii=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=ii)});var x,ni,W=i(()=>{"use strict";n();x="pbrBlockReflectance",ni=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=ni)});var k,ai,Y=i(()=>{"use strict";n();k="pbrBlockDirectLighting",ai=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=ai)});var X,ri,w=i(()=>{"use strict";n();X="pbrBlockFinalLitComponents",ri=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=ri)});var K,oi,z=i(()=>{"use strict";n();K="pbrBlockFinalUnlitComponents",oi=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=oi)});var Z,fi,q=i(()=>{"use strict";n();Z="pbrBlockFinalColorComposition",fi=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=fi)});var r,J,Ra,ti=i(()=>{n();ee();ie();f();Oe();Le();ne();ae();d();ce();Ee();Q();Re();j();_e();Me();he();le();oe();pe();De();Fe();Te();ge();Pe();Ue();de();se();te();E();C();S();A();v();T();p();_();h();F();U();Ce();be();me();B();ue();G();H();a();W();Y();Ae();w();z();q();Ie();ve();Be();ye();Ne();Ge();r="pbrPixelShader",J=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[r]||(e.ShadersStore[r]=J);Ra={name:r,shader:J}});export{Ra as a,ti as b};
