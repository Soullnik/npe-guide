...
fragmentOutputs.color=vec4f(mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel,1.0);}}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);l={name:r,shader:a}});export{l as a,i as b};
