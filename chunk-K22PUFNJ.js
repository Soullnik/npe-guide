...
<< 7u;glFragColor.rgb=vec3(float(tex)/255.0f,0.0f,0.0f);glFragColor.a=1.0;}`;e.ShadersStore[i]||(e.ShadersStore[i]=r);s={name:i,shader:r}});export{s as a,u as b};
