...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=Ne)});var l,Se,f=o(()=>{"use strict";i();r();l="openpbrFragmentSamplersDeclaration",Se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=Ae)});var d,Fe,m=o(()=>{"use strict";i();r();d="openpbrNormalMapFragmentFunctions",Fe=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=Fe)});var u,Te,_=o(()=>{"use strict";i();u="openpbrDielectricReflectance",Te=`struct ReflectanceParams
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Te)});var g,Le,p=o(()=>{"use strict";i();g="openpbrConductorReflectance",Le=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Le)});var E,Oe,I=o(()=>{"use strict";i();E="openpbrBlockAmbientOcclusion",Oe=`struct ambientOcclusionOutParams
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=De)});var F,Me,T=o(()=>{"use strict";i();F="openpbrBlockNormalFinal",Me=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Me)});var L,Pe,O=o(()=>{"use strict";i();L="openpbrBaseLayerData",Pe=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Pe)});var C,Ge,b=o(()=>{"use strict";i();C="openpbrCoatLayerData",Ge=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=We)});var n,B,Fi,Xe=o(()=>{i();Y();Z();a();Re();fe();k();q();f();J();$();V();ee();H();ce();se();de();Q();K();le();me();ue();ae();_e();ge();pe();s();m();j();_();p();I();h();N();oe();Ee();A();T();O();b();M();G();ie();z();U();X();ne();re();Ie();ve();te();he();n="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
