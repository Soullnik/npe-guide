import{a as e,b as m}from"./chunk-RR3YIVG4.js";import{e as t}from"./chunk-FAF55DAL.js";var i,f,x,r=t(()=>{m();i="minmaxReduxPixelShader",f=`varying vec2 vUV;uniform sampler2D textureSampler;
#if defined(INITIAL)
...
discard;}}
#endif
`;e.ShadersStore[i]||(e.ShadersStore[i]=f);x={name:i,shader:f}});export{x as a,r as b};
