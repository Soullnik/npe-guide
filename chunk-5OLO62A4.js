import{a as r,b as l}from"./chunk-RR3YIVG4.js";import{e as a}from"./chunk-FAF55DAL.js";var e,o,i,t=a(()=>{l();e="bilateralBlurQualityPixelShader",o=`uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform sampler2D normalSampler;uniform int filterSize;uniform vec2 blurDir;uniform float depthThreshold;uniform float normalThreshold;varying vec2 vUV;void main(void) {vec3 color=textureLod(textureSampler,vUV,0.).rgb;float depth=textureLod(depthSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(color,1.);return;}
...
`;r.ShadersStore[e]||(r.ShadersStore[e]=o);i={name:e,shader:o}});export{i as a,t as b};
