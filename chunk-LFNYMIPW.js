import{a as ve}from"./chunk-F35RQV3K.js";import{a as te,b as ne,c as fe,d as le,e as ce,g as me,h as de,i as ue,j as pe,k as _e,l as ge}from"./chunk-V4PLSL47.js";import{a as ie,b as se}from"./chunk-CUJCT6RP.js";import{a as oe}from"./chunk-N57R3C6A.js";import{a as ae}from"./chunk-DONP4KGP.js";import{a as w,b as Y,c as Q,d as re}from"./chunk-IZ64GFEV.js";import{a as $}from"./chunk-UIEDLGK2.js";import{a as ee}from"./chunk-WNUYWNJD.js";import{b as q}from"./chunk-43MRWIQD.js";import{b as K}from"./chunk-S6ALFNC7.js";import{b as j}from"./chunk-5YDKXSO5.js";import{a as t}from"./chunk-TD2IO4O7.js";import{b as J}from"./chunk-23BPZRIH.js";import{a as V}from"./chunk-UTVAPBNU.js";import{b as k}from"./chunk-4ZCU3NW4.js";import{b as Z}from"./chunk-6BYDXSMC.js";import{b as B}from"./chunk-MXI7UYZS.js";import{b as H}from"./chunk-H2WJWNOP.js";import{b as X}from"./chunk-HFHHSAGS.js";import{a as e,b as a}from"./chunk-RR3YIVG4.js";import{e as r}from"./chunk-FAF55DAL.js";var n,Se,i=r(()=>{"use strict";a();t();n="openpbrFragmentSamplersDeclaration",Se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=Ie)});var c,Ee,s=r(()=>{"use strict";a();t();c="openpbrNormalMapFragmentFunctions",Ee=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=Ee)});var m,he,d=r(()=>{"use strict";a();m="openpbrDielectricReflectance",he=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=he)});var u,Ne,p=r(()=>{"use strict";a();u="openpbrConductorReflectance",Ne=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=Ne)});var _,Re,g=r(()=>{"use strict";a();_="openpbrBlockAmbientOcclusion",Re=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=Re)});var v,Le,S=r(()=>{"use strict";a();v="openpbrGeometryInfo",Le=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Ae)});var h,Fe,N=r(()=>{"use strict";a();h="openpbrNormalMapFragment",Fe=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=Fe)});var R,Te,L=r(()=>{"use strict";a();R="openpbrBlockNormalFinal",Te=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=Ce)});var M,Me,D=r(()=>{"use strict";a();M="openpbrFuzzLayerData",Me=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=Me)});var x,De,G=r(()=>{"use strict";a();x="openpbrEnvironmentLighting",De=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=De)});var P,xe,z=r(()=>{"use strict";a();P="openpbrDirectLightingInit",xe=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=xe)});var W,Ge,y=r(()=>{"use strict";a();W="openpbrDirectLighting",Ge=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=Ge)});var o,U,pa,Pe=r(()=>{a();w();Y();ve();te();k();i();K();B();V();J();X();ne();ie();fe();j();Z();oe();le();ce();ae();se();me();de();l();s();q();d();p();g();S();E();H();ue();N();L();F();O();C();D();Q();G();z();y();$();ee();pe();_e();re();ge();o="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
