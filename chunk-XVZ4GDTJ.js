...
gl_FragColor=vec4(0.0,0.0,0.0,0.0);else{gl_FragColor=texture2D(textureSampler,tc);}}`;r.ShadersStore[e]||(r.ShadersStore[e]=t);m={name:e,shader:t}});export{m as a,c as b};
