import{a as Ce,b as ue,c as ve,d as Ae,e as Ie,f as Oe,g as Te,h as Le,i as _e,j as Me,k as Fe,l as De}from"./chunk-V4PLSL47.js";import{a as pe,b as Ne}from"./chunk-CUJCT6RP.js";import{a as Se}from"./chunk-BGHS2YA6.js";import{a as Re}from"./chunk-N57R3C6A.js";import{a as me}from"./chunk-DONP4KGP.js";import{a as te}from"./chunk-5BTRONOV.js";import{a as Z,b as J,c as ce,d as Ee}from"./chunk-IZ64GFEV.js";import{a as de}from"./chunk-UIEDLGK2.js";import{a as se}from"./chunk-WNUYWNJD.js";import{b as ee}from"./chunk-43MRWIQD.js";import{b as re}from"./chunk-S6ALFNC7.js";import{b as ie}from"./chunk-5YDKXSO5.js";import{b as ae}from"./chunk-6UKJ3MWI.js";import{b as ne}from"./chunk-UKW3R6OL.js";import{a as $}from"./chunk-TD2IO4O7.js";import{b as fe}from"./chunk-23BPZRIH.js";import{b as oe}from"./chunk-W6JRHX6X.js";import{b as le}from"./chunk-VTA6PJ3E.js";import{a as q}from"./chunk-UTVAPBNU.js";import{b as Q}from"./chunk-4ZCU3NW4.js";import{b as j}from"./chunk-6BYDXSMC.js";import{b as K}from"./chunk-MXI7UYZS.js";import{b as z}from"./chunk-H2WJWNOP.js";import{b as w}from"./chunk-HFHHSAGS.js";import{a as e,b as i}from"./chunk-RR3YIVG4.js";import{e as r}from"./chunk-FAF55DAL.js";var n,he,f=r(()=>{"use strict";i();n="samplerFragmentAlternateDeclaration",he=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=he)});var o,ge,t=r(()=>{"use strict";i();$();f();o="pbrFragmentSamplersDeclaration",ge=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=ge)});var c,Pe,l=r(()=>{"use strict";i();te();c="pbrBlockAlbedoOpacity",Pe=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=Pe)});var d,Ue,s=r(()=>{"use strict";i();d="pbrBlockReflectivity",Ue=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=Ue)});var E,be,m=r(()=>{"use strict";i();E="pbrBlockAmbientOcclusion",be=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=be)});var S,Be,R=r(()=>{"use strict";i();S="pbrBlockAlphaFresnel",Be=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Be)});var C,ye,u=r(()=>{"use strict";i();C="pbrBlockAnisotropic",ye=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=ye)});var p,Ge,v=r(()=>{"use strict";i();p="pbrBlockReflection",Ge=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Ge)});var A,Ve,I=r(()=>{"use strict";i();A="pbrBlockSheen",Ve=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=Ve)});var N,xe,O=r(()=>{"use strict";i();N="pbrBlockClearcoat",xe=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=xe)});var T,He,L=r(()=>{"use strict";i();T="pbrBlockIridescence",He=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=He)});var _,We,M=r(()=>{"use strict";i();_="pbrBlockSubSurface",We=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=We)});var F,Ye,D=r(()=>{"use strict";i();F="pbrBlockNormalFinal",Ye=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=Ye)});var h,ke,g=r(()=>{"use strict";i();h="pbrBlockLightmapInit",ke=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=ke)});var P,Xe,U=r(()=>{"use strict";i();P="pbrBlockGeometryInfo",Xe=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=Xe)});var b,we,B=r(()=>{"use strict";i();b="pbrBlockReflectance",we=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=we)});var y,Ke,G=r(()=>{"use strict";i();y="pbrBlockDirectLighting",Ke=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=Ke)});var V,ze,x=r(()=>{"use strict";i();V="pbrBlockFinalLitComponents",ze=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=ze)});var H,qe,W=r(()=>{"use strict";i();H="pbrBlockFinalUnlitComponents",qe=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=qe)});var Y,Ze,k=r(()=>{"use strict";i();Y="pbrBlockFinalColorComposition",Ze=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[Y]||(e.IncludesShadersStoreWGSL[Y]=Ze)});var a,X,ki,Je=r(()=>{i();Z();J();Se();Ce();Q();t();re();K();q();fe();w();ue();pe();ve();ie();j();Re();Ae();Ie();me();Ne();Te();Le();ae();ne();ee();l();s();m();R();u();v();I();O();L();M();z();_e();oe();D();ce();g();U();Oe();B();G();le();x();W();k();de();se();Me();Fe();Ee();De();a="pbrPixelShader",X=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=X);ki={name:a,shader:X}});export{ki as a,Je as b};
