import{a as p}from"./chunk-FALOAH6P.js";import{a as L}from"./chunk-KGMHW6GI.js";import{a as h}from"./chunk-ZQN5QATT.js";import{a as e,b as i}from"./chunk-RR3YIVG4.js";import{e as t}from"./chunk-FAF55DAL.js";var r,S,m=t(()=>{"use strict";i();p();r="pbrFragmentExtraDeclaration",S=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=S)});var f,D,A=t(()=>{"use strict";i();f="subSurfaceScatteringFunctions",D=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=D)});var o,O,R=t(()=>{"use strict";i();o="pbrHelperFunctions",O=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=O)});var n,C,N=t(()=>{"use strict";i();L();n="pbrDirectLightingSetupFunctions",C=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=C)});var a,I,T=t(()=>{"use strict";i();a="pbrDirectLightingFalloffFunctions",I=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=I)});var c,M,l=t(()=>{"use strict";i();c="pbrBlockReflectance0",M=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=M)});var s,G,_=t(()=>{"use strict";i();h();l();s="pbrDirectLightingFunctions",G=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=G)});var d,P,B=t(()=>{"use strict";i();d="pbrIBLFunctions",P=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=P)});var u,U,F=t(()=>{"use strict";i();u="pbrBlockNormalGeometric",U=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=U)});var E,b,y=t(()=>{"use strict";i();E="pbrBlockImageProcessing",b=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=b)});var g,V,H=t(()=>{"use strict";i();g="pbrBlockPrePass",V=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=V)});var v,x,W=t(()=>{"use strict";i();v="pbrDebug",x=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=x)});export{m as a,A as b,R as c,N as d,T as e,l as f,_ as g,B as h,F as i,y as j,H as k,W as l};
