...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=h)});var f,m,o=r(()=>{"use strict";a();p();n();f="shadowMapFragmentExtraDeclaration",m=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m)});var t,S,_,l=r(()=>{a();o();d();s();c();t="shadowMapPixelShader",S=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
