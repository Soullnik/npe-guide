import{a as e,b as t}from"./chunk-RR3YIVG4.js";import{e as i}from"./chunk-FAF55DAL.js";var l,r,s,o=i(()=>{t();l="colorCorrectionPixelShader",r=`uniform sampler2D textureSampler; 
...
void main(void)
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;e.ShadersStore[l]||(e.ShadersStore[l]=r);s={name:l,shader:r}});export{s as a,o as b};
