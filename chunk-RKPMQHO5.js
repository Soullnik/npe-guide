import{a as Re}from"./chunk-NSWX7W7S.js";import{a as fe,b as ce,c as de,d as me,e as ue,f as pe,g as ge,h as Ee,i as Ie,j as ve,k as he}from"./chunk-5YOEERMD.js";import{a as se,b as _e}from"./chunk-ZLUVLGHH.js";import{a as le}from"./chunk-4QJKXG75.js";import{a as ae}from"./chunk-NOKOI7UI.js";import{a as Z,b as k,c as q,d as ie,e as re}from"./chunk-Z6AOW57W.js";import{a as ne}from"./chunk-TKQC2XFE.js";import{a as te}from"./chunk-MFJUZDUZ.js";import{b as J}from"./chunk-I6YS32MP.js";import{b as Q}from"./chunk-BU36H27E.js";import{b as $}from"./chunk-R4MD35ZT.js";import{b as ee}from"./chunk-NAYG47SM.js";import{a as t}from"./chunk-SEZPQQJY.js";import{b as oe}from"./chunk-ENWF5TL3.js";import{a as Y}from"./chunk-PNTHVEFJ.js";import{b as K}from"./chunk-EQZDMUTF.js";import{b as j}from"./chunk-U5FQI4VF.js";import{b as H}from"./chunk-3Q5BZMII.js";import{b as V}from"./chunk-CGKO47GG.js";import{b as w}from"./chunk-F2BF3OFM.js";import{a as e,b as i}from"./chunk-RR3YIVG4.js";import{e as o}from"./chunk-FAF55DAL.js";var r,Ne,a=o(()=>{"use strict";i();Z();r="openpbrFragmentDeclaration",Ne=`uniform vec4 vEyePosition;uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform vec4 vLightingIntensity;uniform float visibility;
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=Ne)});var l,Se,f=o(()=>{"use strict";i();t();l="openpbrFragmentSamplersDeclaration",Se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=Se)});var c,Ae,s=o(()=>{"use strict";i();c="openpbrNormalMapFragmentMainFunctions",Ae=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=Ae)});var d,Fe,m=o(()=>{"use strict";i();t();d="openpbrNormalMapFragmentFunctions",Fe=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=Fe)});var u,Le,_=o(()=>{"use strict";i();u="openpbrDielectricReflectance",Le=`struct ReflectanceParams
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Le)});var p,Te,g=o(()=>{"use strict";i();p="openpbrConductorReflectance",Te=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Te)});var E,Oe,I=o(()=>{"use strict";i();E="openpbrBlockAmbientOcclusion",Oe=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Oe)});var v,Ce,h=o(()=>{"use strict";i();v="openpbrGeometryInfo",Ce=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=Ce)});var R,be,N=o(()=>{"use strict";i();R="openpbrIblFunctions",be=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=be)});var S,De,A=o(()=>{"use strict";i();S="openpbrNormalMapFragment",De=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=De)});var F,Me,L=o(()=>{"use strict";i();F="openpbrBlockNormalFinal",Me=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Me)});var T,Pe,O=o(()=>{"use strict";i();T="openpbrBaseLayerData",Pe=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Pe)});var C,Ge,b=o(()=>{"use strict";i();C="openpbrCoatLayerData",Ge=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Ge)});var D,xe,M=o(()=>{"use strict";i();D="openpbrThinFilmLayerData",xe=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=xe)});var P,ze,G=o(()=>{"use strict";i();P="openpbrFuzzLayerData",ze=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ze)});var x,ye,z=o(()=>{"use strict";i();x="openpbrEnvironmentLighting",ye=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=ye)});var y,Ue,U=o(()=>{"use strict";i();y="openpbrDirectLightingInit",Ue=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=Ue)});var W,We,X=o(()=>{"use strict";i();W="openpbrDirectLighting",We=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=We)});var n,B,Fi,Xe=o(()=>{i();k();q();a();Re();fe();K();j();f();$();V();Y();oe();H();ce();se();de();ee();J();le();me();ue();ae();_e();pe();ge();s();m();Q();_();g();I();h();N();w();Ee();A();L();O();b();M();G();ie();z();U();X();ne();te();Ie();ve();re();he();n="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[n]||(e.ShadersStore[n]=B);Fi={name:n,shader:B}});export{Fi as a,Xe as b};
