import{a as ve}from"./chunk-F35RQV3K.js";import{a as te,b as ne,c as fe,d as le,e as se,g as me,h as de,i as ue,j as pe,k as _e,l as ge}from"./chunk-V4PLSL47.js";import{a as ie,b as ce}from"./chunk-CUJCT6RP.js";import{a as oe}from"./chunk-N57R3C6A.js";import{a as ae}from"./chunk-DONP4KGP.js";import{a as H,b as V,c as Q,d as re}from"./chunk-IZ64GFEV.js";import{a as $}from"./chunk-UIEDLGK2.js";import{a as ee}from"./chunk-WNUYWNJD.js";import{a as t}from"./chunk-TD2IO4O7.js";import{b as K}from"./chunk-MXI7UYZS.js";import{b as j}from"./chunk-23BPZRIH.js";import{b as J}from"./chunk-H2WJWNOP.js";import{a as B}from"./chunk-UTVAPBNU.js";import{b as w}from"./chunk-BQ2ZPNZF.js";import{b as Y}from"./chunk-F6DONJR2.js";import{b as k}from"./chunk-43MRWIQD.js";import{b as Z}from"./chunk-S6ALFNC7.js";import{b as q}from"./chunk-5YDKXSO5.js";import{b as X}from"./chunk-HFHHSAGS.js";import{a as e,b as a}from"./chunk-RR3YIVG4.js";import{e as r}from"./chunk-FAF55DAL.js";var n,Se,i=r(()=>{"use strict";a();t();n="openpbrFragmentSamplersDeclaration",Se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=Se)});var f,Ie,l=r(()=>{"use strict";a();f="openpbrNormalMapFragmentMainFunctions",Ie=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=Ie)});var s,Ee,c=r(()=>{"use strict";a();t();s="openpbrNormalMapFragmentFunctions",Ee=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=Ee)});var m,he,d=r(()=>{"use strict";a();m="openpbrDielectricReflectance",he=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=he)});var u,Re,p=r(()=>{"use strict";a();u="openpbrConductorReflectance",Re=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=Re)});var _,Ne,g=r(()=>{"use strict";a();_="openpbrBlockAmbientOcclusion",Ne=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=Ne)});var v,Le,S=r(()=>{"use strict";a();v="openpbrGeometryInfo",Le=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Le)});var I,Ae,E=r(()=>{"use strict";a();I="openpbrIblFunctions",Ae=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Ae)});var h,Fe,R=r(()=>{"use strict";a();h="openpbrNormalMapFragment",Fe=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=Fe)});var N,Te,L=r(()=>{"use strict";a();N="openpbrBlockNormalFinal",Te=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=Te)});var A,Oe,F=r(()=>{"use strict";a();A="openpbrBaseLayerData",Oe=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=Oe)});var T,be,O=r(()=>{"use strict";a();T="openpbrCoatLayerData",be=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=be)});var b,Ce,C=r(()=>{"use strict";a();b="openpbrThinFilmLayerData",Ce=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=Ce)});var D,De,M=r(()=>{"use strict";a();D="openpbrFuzzLayerData",De=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=De)});var G,Me,x=r(()=>{"use strict";a();G="openpbrEnvironmentLighting",Me=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=Me)});var P,Ge,z=r(()=>{"use strict";a();P="openpbrDirectLightingInit",Ge=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=Ge)});var W,xe,y=r(()=>{"use strict";a();W="openpbrDirectLighting",xe=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=xe)});var o,U,pa,Pe=r(()=>{a();H();V();ve();te();w();i();Z();K();B();j();X();ne();ie();fe();q();Y();oe();le();se();ae();ce();me();de();l();c();k();d();p();g();S();E();J();ue();R();L();F();O();C();M();Q();x();z();y();$();ee();pe();_e();re();ge();o="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[o]||(e.ShadersStoreWGSL[o]=U);pa={name:o,shader:U}});export{pa as a,Pe as b};
