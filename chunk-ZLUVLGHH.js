...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=o)});var a,f,s=t(()=>{"use strict";i();a="hdrFilteringFunctions",f=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=f)});export{l as a,s as b};
