import{a as r,b as i}from"./chunk-RR3YIVG4.js";import{e as t}from"./chunk-FAF55DAL.js";var e,o,m,a=t(()=>{i();e="fluidRenderingStandardBlurPixelShader",o=`uniform sampler2D textureSampler;uniform int filterSize;uniform vec2 blurDir;varying vec2 vUV;void main(void) {vec4 s=textureLod(textureSampler,vUV,0.);if (s.r==0.) {glFragColor=vec4(0.,0.,0.,1.);return;}
...
`;r.ShadersStore[e]||(r.ShadersStore[e]=o);m={name:e,shader:o}});export{m as a,a as b};
