import{b as c}from"./chunk-HFHHSAGS.js";import{a as e,b as i}from"./chunk-RR3YIVG4.js";import{e as a}from"./chunk-FAF55DAL.js";var r,t,n,u=a(()=>{i();c();r="iblIcdfPixelShader",t=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=t);n={name:r,shader:t}});export{n as a,u as b};
