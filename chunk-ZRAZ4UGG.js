import{a as e,b as l}from"./chunk-RR3YIVG4.js";import{e as n}from"./chunk-FAF55DAL.js";var r,t,a,m=n(()=>{l();r="convolutionPixelShader",t=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform kernel: array<f32,9>;
...
fragmentOutputs.color= vec4f((colorSum/kernelWeight).rgb,1);}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=t);a={name:r,shader:t}});export{a,m as b};
