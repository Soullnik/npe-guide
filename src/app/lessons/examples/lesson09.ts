...
export function createLesson09Set(existingSet?: NodeParticleSystemSet): NodeParticleSystemSet {
  const set = existingSet || new NodeParticleSystemSet('Lesson 09 · Advanced Math Operations');
  set.clear();
  set.editorData = null;
