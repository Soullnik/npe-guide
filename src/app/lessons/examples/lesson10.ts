...
export function createLesson10Set(existingSet?: NodeParticleSystemSet): NodeParticleSystemSet {
  const set = existingSet || new NodeParticleSystemSet('Lesson 10 · Texture Animation and Sprite Sheets');
  set.clear();
  set.editorData = null;
