...
export function createLesson01Set(existingSet?: NodeParticleSystemSet): NodeParticleSystemSet {
  const set = existingSet || new NodeParticleSystemSet('Lesson 01 · First Emission');
  set.clear();
  set.editorData = null;
